...
class Bot(DesktopBot):
    def action(self, execution=None):
        ...
        self.execute(r'C:\Users\Public\Desktop\League of Legends.lnk')

        self.wait(25000)
        
        if not self.find( "jogar", matching=0.97, waiting_time=10000):
            self.not_found("jogar")
        self.click()
        
        if not self.find( "Ranqued", matching=0.97, waiting_time=10000):
            self.not_found("Ranqued")
        self.click()
